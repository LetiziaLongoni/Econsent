<?php 
    ...
    if (isset($_POST['Submit'])) {
        ...
        if(empty($docName)){
            ...
            header('Location:disattivaDocumentoSito.php');
            exit;
...
<html>
  <head>
    ...
    <body>         
        <div class = "container">
            <h1 class="display-3">Disattiva un documento</h1>
            <form action="" method="post">
                <div class = 'form-group'>
                    ...
                    ?>          
                    <div class="col-auto">
                        <label><strong>Documenti attivi nel database:</strong></label>              
                        <div class="input-group mb-2">

                            <select class="form-control" id="Select1" name="Doc" >
                                <option value="" disabled selected hidden>Selezionare il documento che si vuole disattivare</option>
                                <?php     
                                    $querydoc = "SELECT Nome_documento FROM documento
                                    WHERE ID_documento IN 
                                    (SELECT DISTINCT id_documento FROM documento_attivo 
                                    WHERE Attivo=1)";
