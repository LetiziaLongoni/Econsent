...
<html>
  <head>
    ...
    <body>         
        <div class = "container">
            <h1 class="display-3">Seleziona il dizionario che vuoi attivare</h1>
            <form action="" method="post">
                <div class = 'form-group'>
                    ...
                    <?php } ?>          
                    <div class="col-auto">
                        <label><strong>Dizionari presenti nel database:</strong></label>              
                        <div class="input-group mb-2">

                            <select class="form-control" id="Select1" name="Doc" >
                                <option value="" disabled selected hidden>Selezionare il dizionario che si vuole collegare</option>
                                <?php     
